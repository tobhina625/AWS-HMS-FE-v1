...
const routes = [
  ...
  },
  {
    ...
    meta: { title: 'Employees List For Admin', requiresAuth: true },
  },
  {
    path: '/permissions/employee/:id',
    name: 'EmployeesPermissions',
    component: EmployeesPermissionsView,
    meta: { title: 'Employees Permissions', requiresAuth: true },
  },
  {
    path: '/permissions/roles',
    name: 'RolesListForAdmin',
    component: RolesListForPermissions,
    meta: { title: 'Roles List For Admin', requiresAuth: true },
  },
  {
    path: '/permissions/role/:id',
    name: 'RolesPermissions',
    component: RolesPermissionsView,
    meta: { title: 'Roles Permissions', requiresAuth: true },
  },
  {
    path: '/permissions',
    name: 'PermissionsList',
    component: PermissionListView,
    meta: { title: 'Permissions Management', requiresAuth: true },
  },
  {
    path: '/permissions/add',
    name: 'PermissionAdd',
    component: PermissionAddView,
    meta: { title: 'Add Permission', requiresAuth: true },
  },
  {
  ...
  },
  {
    ...
    meta: { title: 'Modules Management', requiresAuth: true },
  },
  {
    path: '/modules/add',
    name: 'ModuleAdd',
    component: ModuleAddView,
    meta: { title: 'Add Module', requiresAuth: true },
  },
  {
    path: '/modules/edit/:id',
    name: 'ModuleEdit',
    component: ModuleEditView,
    meta: { title: 'Edit Module', requiresAuth: true },
  },
  {
    path: '/patienthistoryforpatient',
    name: 'PatientHistory',
    component: PatientDetail,
    meta: { title: 'Patient History', requiresAuth: true },
  },
  {
    path: '/profile',
    name: 'UserProfile',
  ...
  },
  {
    ...
    meta: { title: 'Add Surgery', requiresAuth: true },
  },
  {
    path: '/surgery/edit/:id',
    name: 'surgeryEdit',
    component: SurgeryEditView,
    meta: { title: 'Edit Surgery', requiresAuth: true },
  },
  {
    path: '/surgery/profile/:id',
    name: 'SurgeryProfile',
    component: () => import('@/views/SurgeryUI/ProfileView.vue'),
    meta: { title: 'Surgery Profile', requiresAuth: true },
  },
  {
    path: '/disease',
    name: 'diseases',
  ...
  },
  {
    ...
    meta: { title: 'Add Disease', requiresAuth: true },
  },
  {
    path: '/disease/edit/:id',
    name: 'diseaseEdit',
    component: DiseaseEditView,
    meta: { title: 'Edit Designation', requiresAuth: true },
  },
  {
    path: '/patients',
    name: 'Patients',
  ...
  },
  {
    ...
    meta: { title: 'Add Patient Profile', requiresAuth: true },
  },
  {
    path: '/patients/edit/:id',
    name: 'PatientEdit',
    component: PatientEditView,
    meta: { title: 'Edit Patient Profile', requiresAuth: true },
  },
  {
  ...
  },
  {
    ...
    meta: { title: 'Add Ward Profile', requiresAuth: true },
  },
  {
    path: '/wards/edit/:id',
    name: 'WardEdit',
    component: WardEditView,
    meta: { title: 'Edit Ward Profile', requiresAuth: true },
  },
  {
    path: '/wards/profile/:id',
    name: 'WardProfile',
    component: WardProfileView,
    meta: { title: 'Ward Profile', requiresAuth: true },
  },
  {
    path: '/wards/:id/beds',
    name: 'WardBedManagement',
    component: WardBedManagementView,
    meta: { title: 'Ward Bed Management', requiresAuth: true },
  },
  {
    path: '/patient-history/add',
    name: 'PatientHistoryAdd',
    component: PatientHistoryAddView,
    meta: { title: 'Add Patient History', requiresAuth: true },
  },
  {
    path: '/patient-history/edit/:id',
    name: 'PatientHistoryEdit',
    component: PatientHistoryEditView,
    meta: { title: 'Edit Patient History', requiresAuth: true },
  },
  {
    path: '/designations',
    name: 'designation',
    component: ListView,
    meta: { title: 'Designations', requiresAuth: true },
  },
  {
    path: '/designations/add',
    name: 'designationAdd',
    component: DesignationAddView,
    meta: { title: 'Add Designation', requiresAuth: true },
  },
  {
  ...
  },
  {
    ...
    meta: { title: 'Designation Details', requiresAuth: true },
  },
  {
  ...
  },
  {
    ...
    meta: { title: 'Department Profile', requiresAuth: true },
  },
  {
    path: '/patient-bill',
    name: 'patientbill',
  ...
  },
  {
    ...
    meta: { title: 'Add Patient Bill', requiresAuth: true },
  },
  {
    path: '/patient-bills/edit/:id',
    name: 'patientbillsEdit',
    component: PatientBillsEditView,
    meta: { title: 'Edit Patient Bill', requiresAuth: true },
  },
  {
    path: '/employees/add',
    name: 'EmployeeAdd',
    component: EmployeeAddView,
    meta: { title: 'Add Employee Profile', requiresAuth: true },
  },
  {
    path: '/employees/edit/:id',
    name: 'EmployeeEdit',
    component: EmployeeEditView,
    meta: { title: 'Edit Employee Profile', requiresAuth: true },
  },
  {
  ...
  },
  {
    ...
    meta: { title: 'Schedule Appointment', requiresAuth: true },
  },
  {
    path: '/appointments/edit/:id',
    name: 'appointmentEdit',
    component: AppointmentEditView,
    meta: { title: 'Edit Appointment', requiresAuth: true },
  },
  {
    path: '/inventory',
    name: 'InventoryList',
  ...
  },
  {
    ...
    meta: { title: 'Add Inventory Item', requiresAuth: true },
  },
  {
    path: '/inventory/edit/:id',
    name: 'InventoryEdit',
    component: InventoryEditView,
    meta: { title: 'Edit Inventory Item', requiresAuth: true },
  },
  {
    path: '/lab-tests',
    name: 'LabTestsList',
  ...
  },
  {
    path: '/invoices',
    name: 'InvoicesList',
    component: () => import('@/views/InvoiceUI/ListView.vue'),
    meta: { title: 'Invoices', requiresAuth: true },
  },
  {
    path: '/invoices/add',
    name: 'InvoiceAdd',
    component: () => import('@/views/InvoiceUI/AddView.vue'),
    meta: { title: 'Create Invoice', requiresAuth: true },
  },
...
const checkRoutePermission = (path: string): boolean => {
  ...
  if (publicRoutes.includes(path.toLowerCase())) return true;
  const isAdmin = localStorage.getItem('hms-is-admin') === 'true';
  const userStr = localStorage.getItem('hms-user');
  if (isAdmin || (userStr && JSON.parse(userStr).roles?.some((r: string) => r === 'Admin' || r === 'SuperAdmin' || r === 'System Administrator' || r === 'Hospital Administrator'))) return true;
...
router.beforeEach((to, from, next) => {
  ...
  if (to.meta.requiresAuth && (!token || tokenExpired)) {
    ...
    if (!hasPermission) next({ path: '/', replace: true });
    else next();
  } else {
    next();
  }
