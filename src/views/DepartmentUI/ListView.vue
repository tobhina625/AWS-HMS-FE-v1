...
<template>
  <DefaultLayout>
    ...
    >
      ...
      <template #search>
        <SearchWithViewToggle v-model="viewMode" v-model:date-filter="listFilters.dateFilter" :showAdd="true" placeholder="Search departments..." add-button-route="departments/add" @search="getSearchTerm" />
      </template>
