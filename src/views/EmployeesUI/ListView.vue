...
<template>
  <DefaultLayout>
    ...
    >
      ...
      <template #search>
        <SearchWithViewToggle v-model="viewMode" v-model:date-filter="listFilters.dateFilter" :showAdd="true" placeholder="Search employees..." add-button-route="employees/add" @search="getSearchTerm" />
      </template>
