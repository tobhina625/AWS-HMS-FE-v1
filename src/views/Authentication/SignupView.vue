...
<template>
  <DefaultLayout>
    ...
    <DefaultAuthCard title="Sign Up">
      <form>
        <InputGroup label="First Name" type="text" placeholder="Enter your first name">
          <svg
            class="fill-current"
            width="22"
            height="22"
        ...
        <InputGroup label="Last Name" type="text" placeholder="Enter your last name">
          <svg
            class="fill-current"
            width="22"
            height="22"
        ...
        <InputGroup label="Phone No." type="tel" placeholder="Enter your phone number">
          <svg
            class="fill-current"
            width="22"
            height="22"
        ...
        <InputGroup label="Age" type="number" placeholder="Enter your email">
          <svg
            class="fill-current"
            width="22"
            height="22"
        ...
        <InputGroup label="CNIC" type="email" placeholder="Enter your email">
          <svg
            class="fill-current"
            width="22"
            height="22"
        ...
        <InputGroup label="Address" type="email" placeholder="Enter your email">
          <svg
            class="fill-current"
            width="22"
            height="22"
        ...
        <InputGroup label="Qualification" type="email" placeholder="Enter your email">
          <svg
            class="fill-current"
            width="22"
            height="22"
        ...
        <InputGroup label="Specialization" type="email" placeholder="Enter your email">
          <svg
            class="fill-current"
            width="22"
            height="22"
