...
import AlertPlugIn from '@/views/alertplugin.vue'
...
const handleSignIn = () => {
  ...
  if (email.value === 'test@example.com' && password.value === 'password123') {
    // Success alert
    console.log("Success");
    AlertPlugIn('success', 'Message sent successfully!');
  } else {
    // Warning alert
    AlertPlugIn('attention', 'Incorrect credentials. Please try again!');
  }
};
</script>
