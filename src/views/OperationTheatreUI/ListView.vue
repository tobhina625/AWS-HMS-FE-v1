...
<template>
  <DefaultLayout>
    ...
    >
      ...
      <template #search>
        <SearchWithViewToggle v-model="viewMode" v-model:date-filter="listFilters.dateFilter" :showAdd="true" placeholder="Search theaters..." add-button-route="operation-theatre/add" @search="getSearchTerm" />
      </template>
