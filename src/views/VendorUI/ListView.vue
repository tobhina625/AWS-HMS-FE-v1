...
<template>
  <DefaultLayout>
    ...
    >
      ...
      <template #search>
        <SearchWithViewToggle v-model="viewMode" v-model:date-filter="listFilters.dateFilter" :showAdd="true" placeholder="Search vendors..." add-button-route="vendors/add" @search="getSearchTerm" />
      </template>
