...
<template>
  <DefaultLayout>
    ...
    >
      ...
      <template #search>
        <SearchWithViewToggle v-model="viewMode" v-model:date-filter="listFilters.dateFilter" :showAdd="true" placeholder="Search purchase orders..." add-button-route="purchase-orders/add" @search="getSearchTerm" />
      </template>
