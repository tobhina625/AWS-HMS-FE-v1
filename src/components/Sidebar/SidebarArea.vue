...
<template>
  <aside
    class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-blue duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0"
    :class="{
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
      <router-link to="/">
        <!-- <img src="@/assets/images/logo/logo.svg" alt="Logo" /> -->
         <h1 class="text-lg font-bold text-white dark:text-boxdark">HMS</h1>
      </router-link>
